...
If you're looking for a REST interface, [pe-apptxn-restsupport](https://github.com/evanspa/pe-apptxn-restsupport) exists to provide a REST API on top of the functionality provided by pe-apptxn-core.
